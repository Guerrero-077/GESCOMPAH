...
namespace Entity.Infrastructure.DataInit.AdministrationSystem
{
    public class ModuleSeeder : IEntityTypeConfiguration<Module>
    {
        public void Configure(EntityTypeBuilder<Module> builder)
        {
            ...
            builder.HasData(
                        new Module { Id = 1, Name = "Dashboard", Description = "Panel de control principal", Icon = "home", IsDeleted = false, Active = true, CreatedAt = seedDate },
                        ...
                        new Module { Id = 4, Name = "Seguridad", Description = "Gestión de seguridad y permisos", Icon = "security", IsDeleted = false, Active = true, CreatedAt = seedDate },
                        new Module { Id = 5, Name = "Configuración", Description = "Configuración general del sistema", Icon = "settings", IsDeleted = false, Active = true, CreatedAt = seedDate }
                    );
        }
    }
}