    ...
    public class ModuleSeeder : IEntityTypeConfiguration<Module>
    {
        public void Configure(EntityTypeBuilder<Module> builder)
        {
            ...
            builder.HasData(
                        ...
                        new Module { Id = 4, Name = "Gestion de citas", Description = "Gestión de citas", Icon = "event_note", IsDeleted = false, Active = true, CreatedAt = seedDate },
                        new Module { Id = 5, Name = "Seguridad", Description = "Gestión de seguridad y permisos", Icon = "security", IsDeleted = false, Active = true, CreatedAt = seedDate },
                        new Module { Id = 6, Name = "Configuración", Description = "Configuración general del sistema", Icon = "settings", IsDeleted = false, Active = true, CreatedAt = seedDate }
                    );
        }
    }
}