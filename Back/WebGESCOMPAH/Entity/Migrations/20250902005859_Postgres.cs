        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AreaM2 = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    RentValueBase = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Address = table.Column<string>(type: "text", nullable: false),
                    UvtQty = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTimeAssigned = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBaseRentAgreed = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TotalUvtQtyAgreed = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
