import { LocalesModel, LocalUpdateModel } from "../../../../shared/components/Models/card/card.models";
import { DynamicFormConfig } from "../../../../shared/components/Models/Form/form.models";

export function buildLocalFormConfig(local?: LocalesModel | LocalUpdateModel): DynamicFormConfig {
    return {
